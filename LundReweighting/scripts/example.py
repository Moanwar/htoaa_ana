...
print("Size of pf_cands:", pf_cands.shape)
print("Size of gen_parts_eta_phi:", gen_parts_eta_phi.shape)
print("Size of ak8_jets:", ak8_jets.shape)
print("Size of gen_parts_pdg_id:", gen_parts_pdg_ids.shape)
