...
sIpFile = '/afs/cern.ch/work/m/moanwar/private/siddhesh86/analysis/%s/%s/%s/analyze_htoaa_stage1.root' % (sAnaVersion,Year, anaSuperCat)
sOpDir0 = '/eos/user/m/moanwar/htoaa/analysis/VBF_channel/2DAlphabetfiles_VBF_newCat/%s/%s/%s/2DAlphabet_inputFiles' % (sAnaVersion, Year, anaSuperCat)
