...
Triggers_perEra = {
    Era_2018: {
        'Trg_Combo_AK4AK8Jet_HT': {
            ...
            'HLT_PFHT330PT30_QuadPFJet_75_60_45_40_TriplePFBTagDeepCSV_4p5': ['L1_HTT320er'],
...
massPseudoscalarA_windows_dict = OD([
    ('mA15Window', [14.2, 15.6]),  #old but needed
    ('mA30Window', [28.0, 32.0]),  #old but needed 
    ('mA55Window', [50.0, 58.0]),  #old but needed 
    ('mAless20Window',  [0, 20]),
    ('mA25to35Window',  [25, 35]),
    ('mA45to100Window', [45, 100]),
    ('mAIncWindow',     [0, 100]),
])
massHiggs_windows_dict = {
    'MsoftdropHiggsWindow': [110, 140], 
    'PNet_massH_Hto4b_HiggsWindow': [110, 140],
    'FatJetMass_IncWindow' : [50,300],
    'FatJetMass_HiggsWindow': [100,140],    
}
